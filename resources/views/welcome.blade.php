...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <!--This contains the content shown on the welcome page (prior to registration or login)-->
