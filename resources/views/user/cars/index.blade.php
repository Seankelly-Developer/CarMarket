<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <a href = "{{ route('user.cars.create') }}" class = "btn-link btn-lg mb-2"> Create a new Advertisement</a>
            ...
            @foreach ($Cars as $car)
                    ...
                    <a href = "{{ route('user.cars.show', $car) }}" class = "btn-link ml-auto mt-10">View advertisement</a>
                </div>
            @endforeach
